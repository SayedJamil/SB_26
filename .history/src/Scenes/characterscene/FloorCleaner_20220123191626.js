...
export default function FloorCleaner({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_11.svg", "/assets/audio/SB_26_Audio_28.mp3")
    const { Sound, setSound } = useContext(SoundContext)

    const [iconGirl, setIconGirl] = useState("")
    const [floorCleaner, setFloorCleaner] = useState("")
    ...
    const LoadBGImage = async () => {
        ...
        setFloorCleaner(await LoadImage("/assets/character/SB_26_CE_florecleaner01.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(floorCleaner)}`} alt="" className=' floorCleanerSceneIcon' />
