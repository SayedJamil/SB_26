...
export default function FireFighter({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_10.svg", "/assets/audio/SB_26_Audio_27.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setFireFighter(await LoadImage("/assets/character/SB_26_CE_firefighter.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(fireFighter)}`} alt="" className=' fireFighterSceneIcon' />
