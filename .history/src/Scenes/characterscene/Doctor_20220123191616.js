...
export default function Doctor({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_02.svg", "/assets/audio/SB_26_Audio_03.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setDoctor(await LoadImage("/assets/character/SB_26_CE_docter01.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(doctor)}`} alt="" className=' doctorSceneIcon' />
