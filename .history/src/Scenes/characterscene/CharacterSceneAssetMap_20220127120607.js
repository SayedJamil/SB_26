...
const CharacterSceneMap = {
    ...
    dentist: {
        ...
        lottie: [
            `${lottieUrl}Scene_07/SB_26_Scene_30.json`,
        ]
    },
    doctor: {
        id: "characterscene",
        ...
        lottie: [
            `${lottieUrl}Scene_07/SB_26_Scene_03.json`,
        ]
    },
    fireFighter: {
        id: "characterscene",
        ...
        lottie: [
            `${lottieUrl}Scene_07/SB_26_Scene_27.json`,
        ]
    },
    floorCleaner: {
        id: "characterscene",
        ...
        lottie: [
            `${lottieUrl}Scene_07/SB_26_Scene_28.json`,
        ]
    },
    garbageCollector: {
        id: "characterscene",
