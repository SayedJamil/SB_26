...
export default function Gardener({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_04.svg", "/assets/audio/SB_26_Audio_05.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setGardener(await LoadImage("/assets/character/SB_26_CE_gardener.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(gardener)}`} alt="" className=' gardenerSceneIcon' />
