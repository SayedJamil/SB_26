...
function Teacher() {
    const { Bg, Loading } = useLoadAsset(CharacterSceneMap.teacher)
        ...
        <Scenes
            ...
            sprites={
                <>
                    ...
                    <Image src={characterscene?.sprites[1]} alt="txt" className="" />

                    <div ref={Ref} className="armyManSceneIcon" id="armyman"></div>
                </>
            }
        />
    );
