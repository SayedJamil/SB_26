...
export default function Police({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_05.svg", "/assets/audio/SB_26_Audio_06.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setPolice(await LoadImage("/assets/character/SB_26_CE_police.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(police)}`} alt="" className=' policeSceneIcon' />
