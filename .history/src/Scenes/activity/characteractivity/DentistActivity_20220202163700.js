...
function DentistActivity() {//change here
    const { Bg, Loading } = useLoadAsset(CharacterActivityAsset.dentist)//change here
    ...
    useEffect(() => {
        if (characteractivity && Ref29.current && !Loading) {//change here
            try {
        ...
        <Scenes
            ...
            sprites={
                <>
                    ...
                    <div ref={Ref29} className="floorCleanerSceneIcon" id="characterAnimation"></div>//change here
