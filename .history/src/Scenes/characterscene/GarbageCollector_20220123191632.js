...
export default function GarbageCollector({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_14.svg", "/assets/audio/SB_26_Audio_31.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setGarbageCollector(await LoadImage("/assets/character/SB_26_CE_garbage collector.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(garbageCollector)}`} alt="" className=' garbageCollectorSceneIcon' />
