...
function DoctorActivity() {//change here
    const { Bg, Loading } = useLoadAsset(CharacterActivityAsset.doctor)//change here
        ...
        <Scenes
            ...
            sprites={
                <>
                    ...
                    {(wrong) ? <Image src={characteractivity?.sprites[19]} alt="txt" className={`${!position ? "bottomHighlightIcon" : "topHighlightIcon"}`} onClick={() => wrongAnswerSound()} /> : null}
