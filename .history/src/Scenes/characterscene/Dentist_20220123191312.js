...
export default function Dentist({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_13.svg", "/assets/audio/SB_26_Audio_29.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setDentist(await LoadImage("/assets/character/SB_26_CE_dentist.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(dentist)}`} alt="" className=' dentistSceneIcon' />
