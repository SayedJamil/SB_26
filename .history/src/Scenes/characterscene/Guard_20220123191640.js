...
import "../styles/armyman.css"
import { SoundContext } from '../contexts/SoundContext'
import { SceneContext } from '../contexts/SceneContext'
import { LoadImage } from '../utils/loadImage'
import { Howl } from "howler"

export default function Guard({ isExcellent = false }) {
    ...
    const { Loading, Bg } = useLoadAsset("/assets/bg/BG/SB_26_BG_12.svg", "/assets/audio/SB_26_Audio_30.mp3")
    ...
    const LoadBGImage = async () => {
        ...
        setGuard(await LoadImage("/assets/character/SB_26_CE_guard.svg"))
        ...
        <Scenes
            ...
            stripes={
                <>
                    ...
                    <img src={`data:image/svg+xml;utf8,${encodeURIComponent(guard)}`} alt="" className=' guardSceneIcon' />
